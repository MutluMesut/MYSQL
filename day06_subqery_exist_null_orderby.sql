...
-- ismi null olan kayitlari siralayiniz
...
-- asc yazilmaso bile default olark dogal siralama yapar
...
-- burda ayni degerde veriler oldukca bir sonraki adim devreye girer. 
-- adres field e ayni  degere sahip veri var ise isim gecilir, isimden soyisime gecmesi icin
-- isimlerde ayni degerin olmasi gerekir
