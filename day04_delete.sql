...
SAVEPOINT CICEK; -- bu satirda olusturdurgumuz  yeni bir alana bilgileri kaydediyoruz

SELECT * FROM COCUK;


-- id si 124 ten buyuk olan kayıtlari silin
...
===================================================================================*/
    ...
    -- delete komut ile calisır. -- eger drop kullanilrsa hata ver
    ...
    WHERE id>125; -- parenteki silerek, child taki veriler de on delete cascade ile silinmiş olur
				  -- on delete cascade bu komut ile once child silinmeli sonra parent slinmeli
                  -- kurali asilmiş olur
